...
import '../../prescribed_medicine_times/prescribed_medicine_time_view.dart';
import 'prescribed_medicine_item.dart';

class PrescribedMedicineCard extends StatelessWidget {
  const PrescribedMedicineCard({Key? key,required this.prescribedMedicine}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
        Get.toNamed(PrescribedMedicineTimePage.routeName,arguments: prescribedMedicine);
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  Ui.circularImgRadius(url: prescribedMedicine.image,size: 50,margin: 0),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            UiHelper.horizontalSpaceSmall,
                            Expanded(child: Text(prescribedMedicine.medicine,textAlign: TextAlign.start,style: AppStyles.primaryStyle(bold: true,fontSize: 15),)),
                          ],
                        ),
                      ...
                      //  UiHelper.verticalSpaceTiny,
                       ...
                       Row(children: [
                         ...
                         Expanded(child:               PrescribedMedicineItem(icon: '',title: 'Dose : ',text: '${prescribedMedicine.dose}  ${prescribedMedicine.doseUnit}',unit: '',),
                         )
                     ...
                     //   UiHelper.verticalSpaceTiny,
                        ...
                        Row(children: [
                          ...
                          Expanded(child:               PrescribedMedicineItem(icon: '',title: 'Frequency : ',text: '${prescribedMedicine.frequency} ',unit: '',),
                          )
                     ...
                     //  UiHelper.verticalSpaceTiny,
                       Row(children: [
                         ...
                         Expanded(child:               PrescribedMedicineItem(icon: '',title: 'Ad. Route : ',text: prescribedMedicine.doseRoute,unit: '',),
                         )
                       ],),
                        UiHelper.verticalSpaceSmall,


                        // PrescribedMedicineItem(icon: AppImages.comment,title: 'Comment : ',text: prescribedMedicine.comment,unit: '',),
                      ],
                    ),
                  ),
              ...
              Column(children: [
               ...
               child: Icon(Icons.arrow_forward,color: AppColors.white,size: 20.sp,),
               )
