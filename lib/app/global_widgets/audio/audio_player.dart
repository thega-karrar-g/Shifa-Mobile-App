...
class AudioPlayer extends StatefulWidget {
  ...
  const AudioPlayer({required this.source, required this.onDelete, Key? key})
      : super(key: key);
...
class AudioPlayerState extends State<AudioPlayer> {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        return Row(
          ...
          children: <Widget>[
            _buildControl(),
            _buildSlider(Get.width * .4),
            IconButton(
              icon: Icon(Icons.close,
                  color: AppColors.subTitleColor, size: _deleteBtnSize),
              onPressed: () {
  ...
  Widget _buildControl() {
    ...
    if (_audioPlayer.playerState.playing) {
      ...
      icon =
          Icon(Icons.play_arrow, color: AppColors.primaryColorGreen, size: 30);
      color = AppColors.primaryColorGreen.withOpacity(0.1);
    }
  ...
  Widget _buildSlider(double widgetWidth) {
    ...
    return SizedBox(
      ...
      child: Slider(
        activeColor: AppColors.primaryColorGreen,
